...
func newRecGRPCServer(cert, caCert *x509.Certificate, priv *ecdsa.PrivateKey, l net.Listener) (*gRPCServer, error) {
...
func (s *gRPCServer) Register(p pb.RecServer) {
	pb.RegisterRecServer(s.rpcServer, p)
}
