...
func (m *HandshakeResponse) GetKey() []byte {
	if m != nil {
		return m.Key
	}
	return nil
...
type GossipMessage struct {
	...
	PolicyStoreTime      *timestamp.Timestamp `protobuf:"bytes,3,opt,name=PolicyStoreTime,proto3" json:"PolicyStoreTime,omitempty"`
...
func (m *GossipMessage) GetPolicyStoreTime() *timestamp.Timestamp {
	if m != nil {
		return m.PolicyStoreTime
	}
	return nil
}
...
type GossipMessageBody struct {
	...
	Body                 *GossipMessageBody `protobuf:"bytes,3,opt,name=Body,proto3" json:"Body,omitempty"`
...
func (m *GossipMessageBody) GetBody() *GossipMessageBody {
	if m != nil {
		return m.Body
	}
	return nil
...
var fileDescriptor_a0b84a42fa06f626 = []byte{
	...
	,
}
