...
func (c *policyStoreClient) GetObjectHeaders(ctx context.Context, in *google_protobuf.Empty, opts ...grpc.CallOption) (*ObjectHeaders, error) {
	out := new(ObjectHeaders)
	err := grpc.Invoke(ctx, "/proto.PolicyStore/GetObjectHeaders", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *policyStoreClient) StoreObjectHeader(ctx context.Context, in *ObjectHeader, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	out := new(google_protobuf.Empty)
	err := grpc.Invoke(ctx, "/proto.PolicyStore/StoreObjectHeader", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PolicyStore_GetObjectHeaders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(google_protobuf.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PolicyStoreServer).GetObjectHeaders(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.PolicyStore/GetObjectHeaders",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PolicyStoreServer).GetObjectHeaders(ctx, req.(*google_protobuf.Empty))
	}
	return interceptor(ctx, in, info, handler)
}

func _PolicyStore_StoreObjectHeader_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ObjectHeader)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PolicyStoreServer).StoreObjectHeader(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.PolicyStore/StoreObjectHeader",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PolicyStoreServer).StoreObjectHeader(ctx, req.(*ObjectHeader))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _PolicyStore_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetObjectHeaders",
			Handler:    _PolicyStore_GetObjectHeaders_Handler,
		},
		{
			MethodName: "StoreObjectHeader",
			Handler:    _PolicyStore_StoreObjectHeader_Handler,
		},
		{
...
var fileDescriptor0 = []byte{
	...
	,
}
