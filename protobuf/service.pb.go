...
type Message struct {
	...
	// Other fields
	StringValue          string   `protobuf:"bytes,10,opt,name=stringValue,proto3" json:"stringValue,omitempty"`
	StringSlice          []string `protobuf:"bytes,11,rep,name=stringSlice,proto3" json:"stringSlice,omitempty"`
	Bytes                []byte   `protobuf:"bytes,12,opt,name=Bytes,proto3" json:"Bytes,omitempty"`
	BytesSlice           [][]byte `protobuf:"bytes,13,rep,name=BytesSlice,proto3" json:"BytesSlice,omitempty"`
	BoolValue            bool     `protobuf:"varint,14,opt,name=boolValue,proto3" json:"boolValue,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_a0b84a42fa06f626 = []byte{
	...
	,
}
